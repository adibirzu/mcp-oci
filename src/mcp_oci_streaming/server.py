...
def list_streams(compartment_id: str, name: Optional[str] = None, limit: Optional[int] = None,
...
def get_stream(stream_id: str, profile: Optional[str] = None, region: Optional[str] = None) -> Dict[str, Any]:
    client = create_client(profile=profile, region=region)
